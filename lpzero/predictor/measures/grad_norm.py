...
def get_grad_norm_arr(net, inputs, targets=None, loss_fn=None, split_data=1, skip_grad=False):
    net.train()
...
def get_grad_norm_arr1(net, inputs, targets, loss_fn, split_data=1, skip_grad=False):
    net.train()
    for param in net.parameters():
        param.grad = None
